...
public class studyRecord {
    ...
    public void setSchoolofStudent(String schoolofStudent) {
        this.schoolofStudent = schoolofStudent;
    }
    public void setConfirmnameofSchool(String confirmnameofSchool) {
    ...
    public String getSchoolofStudent() {
        return schoolofStudent;
    }
    public String getConfirmnameofSchool() {
        return confirmnameofSchool;
    }
}
